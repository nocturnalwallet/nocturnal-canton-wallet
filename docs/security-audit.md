...
The RSA public key is hardcoded to pin the extension ID to `iijglelilemfjgadbekgleiclimbaopf`. If the corresponding private key is leaked, an attacker can publish a malicious extension with the same ID.
